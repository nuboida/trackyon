...
@UntilDestroy()
@Component({
  selector: 'olla-appraisalDialog',
  templateUrl: './appraisalDialog.component.html',
  styleUrls: ['./appraisalDialog.component.scss']
})
export class AppraisalDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AppraisalDialogComponent>,
